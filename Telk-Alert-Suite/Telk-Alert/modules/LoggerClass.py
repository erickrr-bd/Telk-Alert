...
class Logger:
	...
	"""
	def createLogTelkAlert(self, message, type_log):
		logger = logging.getLogger('Telk_Alert_Log')
		logger.setLevel(logging.INFO)
		fh = logging.FileHandler('/var/log/Telk-Alert/telk-alert-log-' + str(date.today()) + '.log')
		...
		os.chown('/var/log/Telk-Alert/telk-alert-log-' + str(date.today()) + '.log', uid, gid)